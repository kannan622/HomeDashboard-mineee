...
//<<<<<<<<<<<<<<<<<LIVE>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    public static String office_bear = "http://kanna.talentdatatechnologies.com/web_services/office_bearears.php";
    public static String chennaizone = "http://kanna.talentdatatechnologies.com/web_services/zone_wise_members.php";
    public static String events = "http://kanna.talentdatatechnologies.com/web_services/events.php";

    public static String role_of_honour = "http://kanna.talentdatatechnologies.com/web_services/role_of_honour.php";
